/********************************************************************************
	File: 		System/Cryptography/RipeMD160Provider.js
	Version: 	1.0.0
	Date:		2003-12-15
...
Cryptography.RipeMD160Provider = function() {
	...
	function mixOneRound(a, b, c, d, e, x, s, roundNumber) {
		switch (roundNumber) {
			...
			default : throw new Exception("Cryptography.RipeMD160Provider[mixOneRound]: bad roundNumber passed (" + roundNumber + ").") ;
		}	
		a = ROL(a, s) + e;
		c = ROL(c, 10);
		a &= 0xffffffff;
